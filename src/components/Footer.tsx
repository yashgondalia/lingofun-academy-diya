...
// import { Phone, Instagram, Linkedin, Star, Mail } from "lucide-react";
...
//               </li>
//               <li className="flex items-start">
//                 <Mail className="h-5 w-5 text-lingofun-primary mt-0.5 mr-3" />
//                 <a
//                   href="mailto:thelingofunnacademy@gmail.com"
//                   className="text-gray-400 hover:text-white transition-colors"
//                 >
//                   Email:thelingofunnacademy@gmail.com
//                 </a>
//               </li>
//             </ul>
//           </div>
