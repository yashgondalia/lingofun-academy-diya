          ...
          <div className="flex items-center">
            {imageSrc ? (
              <img
                src={imageSrc}
                alt={author}
                className="w-10 h-10 rounded-full mr-4 border-2 border-lingofun-primary object-cover"
              />
            ) : (
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center mb-16">
          ...
          <p className="text-gray-600 reveal stagger-3">
            Hear from our students who have transformed their language skills
            through our personalized teaching approach.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="reveal stagger-3">
